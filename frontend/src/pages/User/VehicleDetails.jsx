  ...
  useEffect(() => {
    const loadPreviousBooking = async () => {
      try {
        const data = await fetchLatestBookingInfo();
  ...
  <div className="space-y-1">
    ...
    <input
      ...
      className="w-full bg-slate-50 border border-slate-200 rounded-2xl p-3 text-xs focus:ring-2 focus:ring-blue-500 outline-none transition-all"
    />
  </div>
